...
export default function BubbleSort_Theory() {
  const data = loadTheoryData(defaultTheoryData);
  const theory = data.find((item) => item.key === "bubble-sort") || defaultTheoryData[2];
          ...
          <div>
            ...
            <div className="flex flex-wrap">
              ...
              >
                <CardStats
                  statTitle="Theory"
                  statDescripiron="Practical 3 - Bubble Sort"
      ...
      <main className="container mx-auto px-12 py-8 flex-grow">
        <div className="border-8 border-gray-800 p-8 rounded-lg bg-white shadow-lg w-11/12 mx-auto">
          ...
          <section className="mb-8">
            ...
            <div className={theory.imageContainerClassName || "mt-4 h-auto w-auto"}>
              <img
                src={imageSrc}
                alt={theory.imageAlt}
                className={theory.imageClassName || "w-full max-w-xl mx-auto border border-gray-300 shadow-lg"}
                style={theory.imageStyle || { height: "800px" }}
              />
            </div>
          </section>
          ...
          <Link to="/admin/dashboard">
            ...
            <Link to="/admin/dashboard/bubbleSort">
              <button
